      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 212px;" aria-label="Browser: activate to sort column ascending">用户名</th>
        ...
        @foreach($users as $k=>$v)
          ...
          ">
           ...
           <td class=" "><a href="/admin/user/edit/{{$v['id']}}" ><i class="icon-pencil" style="color:black"></i></a>| <a href="/admin/user/delete/{{$v['id']}}"><i class="icon-remove"style="color:red"></i></a></td>
           @endforeach
