      ...
      <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1" aria-describedby="DataTables_Table_1_info">
        <thead>
          <tr role="row">
            ...
            <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1" rowspan="1" colspan="1" style="width: 197px;" aria-label="Platform(s): activate to sort column ascending">分类路径</th>
        ...
        @foreach($cates as $k=>$v)
          ...
          ">
           ...
           <td class=" "><a href="/admin/cate/edit/{{$v['id']}}" ><i class="icon-pencil" style="color:black"></i></a>| <a href="/admin/cate/delete/{{$v['id']}}"><i class="icon-remove"style="color:red"></i></a></td>
           @endforeach
